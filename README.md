# Proyecto-Final-KP
 Aplicación en Streamlit para analizar y predecir el volumen de financiamientos de vivienda en México (2023–2025) mediante visualizaciones interactivas y modelos de Machine Learning. Incluye dashboard, análisis exploratorio, perfil del acreditado y proyecciones basadas en regresión lineal
